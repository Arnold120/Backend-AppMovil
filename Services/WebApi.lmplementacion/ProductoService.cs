...
namespace WebApi.Implementacion
{
    public class ProductoService : IProductoService
    {
        ...
        public IEnumerable<Producto> GetAll2()
        {
                ...
                using (var reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        productos.Add(new Producto
                        {
                            ...
                            CapacidadUnidad = reader.GetInt32(5),
                            Cantidad = reader.GetInt32(6),
                            PrecioVenta = reader.GetDecimal(7),
                            CostoCompra = reader.GetDecimal(8),
                            MargenGanancia = reader.GetDecimal(9),
                            PorcentajeMargen = reader.GetDecimal(10),
                            EstadoStock = reader.IsDBNull(11) ? null : reader.GetString(11),
                            Activo = reader.IsDBNull(12) ? (bool?)null : reader.GetBoolean(12),
                            FechaRegistro = reader.IsDBNull(14) ? (DateTime?)null : reader.GetDateTime(14)
                        });
                    }
                }
            }
